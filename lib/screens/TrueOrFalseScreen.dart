...
class _TrueOrFalseScreen extends State<TrueOrFalseScreen> {
  getData(int number1, int number2, String calculation) async {
    ...
    var res = await db.query(calculation,
        where: "number1 = ? and number2 = ?", whereArgs: [number1, number2]);
      ...
      body: Container(
        child: GridView.count(
          ...
          children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                          image: AssetImage(
                              "assets/images/Number of Wrong Answer.png"),
                          fit: BoxFit.cover,
                        )),
                      ),
                    ],
            ...
            Image.asset(
              "assets/images/thinking_boy.png",
            )
          ],
        ),
      ),
